...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidW55dHR5IiwiYSI6ImNrY2o4aDV3MzFnZGoydHAwdWJ5c3Uwam4ifQ.Qcrmah1KMQjIyEzPP62a7w';
...
var stripe = Stripe('pk_test_51H84zMKYQlB9iqBEH0FgJVzskOl03zHYWyXTfMC4HPcRRj7JoPAeaOFqgDrW4mha7Pmbo6EXWmWoxA9JGnzT4Wn600AZEqr96s');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Sign up is successfully!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1000);
            }
